<!--
    ...
    Date: 2026-1-9
    Description: Participants management page for collaborator based on collaborator event.
-->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    $sql = "SELECT 
                ep.id, ep.user_id, ep.receipt_path, ep.approval_status,
                ep.approved_by, ep.approved_at, ep.coins_earned, ep.registered_at,
                u.first_name, u.last_name, u.apkey, u.avatar_path,
                approver.first_name AS approver_first_name,
                approver.last_name AS approver_last_name,
                approver.apkey AS approver_apkey,
                approver.avatar_path AS approver_avatar
            FROM event_participants ep
            JOIN users u ON ep.user_id = u.id
            LEFT JOIN users approver ON ep.approved_by = approver.id
    ...
    ?>
    <title>Participants - Collaborator | GoGreen@APU</title>
    ...
    <main>
        ...
        <div class="table-actions-container glass-effect">
            <div class="table-filters">
                <div class="filter-group glass-effect-border">
                    ...
                    <select id="filter-status"
                        onchange="location.href='?id=<?php echo $event_id; ?>&filter=' + this.value">
                        ...
                        <option value="approved" <?php if ($filter == 'approved') {
                            echo 'selected';
                        } ?>>Approved
                        </option>
                        <option value="rejected" <?php if ($filter == 'rejected') {
                            echo 'selected';
                        } ?>>Rejected
                        </option>
                    </select>
            ...
            <div class="table-manage-container glass-effect-border">
                                    ...
                                    <tr>
                                        <td class="event-title">
                                            <span class="user-avatar">
                                                <img src="/GoGreen-APU/assets/images/profile/<?php echo $p['avatar_path']; ?>"
                                                    alt="">
                                            </span>
                                        ...
                                        <td><span
                                                class="status-badge <?php echo $status_class; ?>"><?php echo $status_text; ?></span>
                                        </td>
                                        <td>
                                            <?php if ($p['approved_by'] !== null): ?>
                                                <span class="approver-info">
                                                    <span class="user-avatar-small">
                                                        <img src="/GoGreen-APU/assets/images/profile/<?php echo $p['approver_avatar']; ?>"
                                                            alt="">
                                                    </span>
                                                    <span class="user-info">
                                                        <span
                                                            class="approver-name"><?php echo htmlspecialchars($p['approver_last_name'] . ' ' . $p['approver_first_name']); ?></span>
                                                        <span
                                                            class="approver-apkey"><?php echo htmlspecialchars($p['approver_apkey']); ?></span>
                                                    </span>
                                                </span>
                                            <?php else: ?>
                                                -
                            ...
                            <tbody>
                                <?php foreach ($participants as $p): ?>
                                    ...
                                    <tr>
                                        <?php if ($is_paid == 1): ?>
                                            <td>
                                                <a href="/GoGreen-APU/lib/pdfjs/web/viewer.html?file=../../../uploads/receipt/<?php echo $p['receipt_path']; ?>"
                                                    target="_blank">
                                        ...
                                        <?php endif; ?>
                                        <td>
                                            <form action="/GoGreen-APU/actions/event/approve_participant.php"
                                                method="GET">
                                        ...
                                        <td>
                                            <a href="/GoGreen-APU/actions/event/delete_participant.php?id=<?php echo $event_id; ?>&participant_id=<?php echo $p['id']; ?>"
                                                onclick="return confirm('Delete this participant?');">
                                                <span class="trash-btn"><img src="/GoGreen-APU/assets/icons/trash.svg"
                                                        alt="Delete"></span>
                                            </a>
                                        </td>
                                    </tr>
                ...
                <?php else: ?>
                    <div
                        style="display: flex; flex-direction: column; justify-content: center; align-items: center; min-height: 300px; width: 100%;">
                        ...
                        <h3 style="font-size: 22px; margin-bottom: 10px; color: rgba(255,255,255,0.8);">No Participants Yet
                        </h3>
                        <p style="font-size: 15px; color: rgba(255,255,255,0.5);">No one has registered for this event yet.
                        </p>
                    </div>
                <?php endif; ?>
            </div>
