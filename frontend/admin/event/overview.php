 <!--
    ...
    Date: 2026-1-8
    Description: Admin interface for viewing an overview of a specific event, including general information, contact details, participant growth chart, and event timeline.
-->
