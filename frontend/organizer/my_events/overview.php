 <!--
    ...
    Date: 2026-1-11
    Description: Organizer interface for viewing an overview of a specific event, including general information, contact details, participant growth chart, and event timeline.
-->
<!DOCTYPE html>
<html lang="en">
