<!-- 
    Author: Khoo Lay Bin
    Date: 2025-11-5
    Description: Organizer my events certificate preview page that include certificate layout
-->
...
<body>
    ...
    <main>
        ...
        <div class="certificate-page" style="margin: 24px 70px 20px;">
            ...
            <a href="/GoGreen-APU/frontend/organizer/my_events/certificate.php?id=<?php echo $event_id; ?>" class="cert-back-btn glass-effect-card">
