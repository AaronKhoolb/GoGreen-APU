 <!--
    ...
    Date: 2026-1-6
    Description: Organizer interface for creating a new event according organizer event id.
-->
<?php
...
<head>
    ...
    <title>Create Event - My Events | GoGreen@APU</title>
...
<body>
    ...
    <main>
        <section class="page-content">
            <form action="/GoGreen-APU/actions/organizer/my_events/create_event.php" method="post"
                enctype="multipart/form-data" id="create-event-form">
                <div class="page-header">
                    <h2>Create New Event</h2>
                    <div class="header-actions">
                        <button type="reset" class="btn-discard" value="Discard">
                ...
                <div class="form-part">
                    ...
                    <div class="form-part-content">
                        ...
                        <div class="form-field">
                            <label for="details">Details <span class="required-star">*</span></label>
                            <div class="txt-container glass-effect-border">
                        ...
                        <div class="form-field">
                            <label for="event_cover">Event Cover Image</label>
                            <p class="form-hint">Upload an image for the event cover (JPG, PNG, GIF, WebP, SVG)</p>
                            <div class="txt-container glass-effect-border">
    ...
    <script>
        <?php if (isset($_SESSION['success_message']) && !isset($_SESSION['_success_shown'])): ?>
            const successMessage = '<?php echo addslashes($_SESSION['success_message']); ?>';
            alert(successMessage);
            <?php $_SESSION['_success_shown'] = true;
            unset($_SESSION['success_message']); ?>
        <?php endif; ?>

        <?php if (isset($_SESSION['error_message']) && !isset($_SESSION['_error_shown'])): ?>
            const errorMessage = '<?php echo addslashes($_SESSION['error_message']); ?>';
            alert(errorMessage);
            <?php $_SESSION['_error_shown'] = true;
