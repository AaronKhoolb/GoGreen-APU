<!--
    Author: Khoo Lay Bin
    Date: 2026-1-5
    Description: Organizer My Events Generate Certificate Page
-->
...
<head>
    ...
    <title>Certificate - My Events</title>
...
<body>
    ...
    <main>
        ...
        <section class="page-content">
            ...
            <form action="/GoGreen-APU/actions/organizer/my_events/certificate.php" method="post" enctype="multipart/form-data">
                <div class="page-header">
                    ...
                    <div class="header-actions">
                        ...
                        <a href="/GoGreen-APU/frontend/organizer/my_events/certificate/preview.php?id=<?php echo $event_id; ?>" class="btn-preview glass-effect-border">
