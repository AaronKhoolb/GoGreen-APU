 <!--
    ...
    Date: 2026-1-7
    Description: Create Collaborator Page for Organizer for current event.
-->
<?php
...
<body>
    ...
    include($root_path . '/frontend/organizer/sidebar.php');
    ?>

    <main>
        <?php include($root_path . '/frontend/organizer/my_events/hero.php'); ?>
