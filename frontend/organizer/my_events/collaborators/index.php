 <!--
    ...
    Date: 2026-1-6
    Description: Collaborators List Page for Organizer based on current event.
-->
 <!DOCTYPE html>
 <html lang="en">
 ...
 <body>
     ...
     <main>
         ...
         <div class="page-header">
             ...
             <a href="/GoGreen-APU/frontend/organizer/my_events/collaborators/create.php?id=<?php echo $event_id; ?>"
