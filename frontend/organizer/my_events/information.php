<!--
    Author: Khoo Lay Bin
    Date: 2026-1-5
    Description: Organizer My Events Edit Information Page
-->
...
<head>
    ...
    <title>Information - My Events</title>
    ...
    <main>
        ...
        <section class="page-content">
            ...
            <form action="/GoGreen-APU/actions/organizer/my_events/information.php" method="post" enctype="multipart/form-data" id="event-info-form">
                ...
                <!-- Part 3. Transportation + Participation & Fees -->
                <div class="form-subpart">
                    <!-- 3a. Transportation -->
                    <div class="form-part">
                        <div class="form-part-header">
                ...
                <!-- Part 4. Sustainable Development Goals -->
                <div class="form-part">
                    <div class="form-part-header">
