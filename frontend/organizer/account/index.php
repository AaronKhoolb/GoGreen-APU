<!--
    ...
    Date: 2025-12-30
    Description: Organizer Account Page
-->
<?php
...
<html lang="en">
<head>
    <title>GoGreen@APU - Organizer Profile</title>
...
<body>
    <?php include($_SERVER['DOCUMENT_ROOT'] . '/GoGreen-APU/frontend/organizer/sidebar.php'); ?>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="page-header">
                    <div class="header-title">
                        ...
                        <p style="color: #888; font-size: 14px; margin-top: 5px;">Update your profile and security settings.</p>
                    </div>
                    ...
                    <div class="form-part-content">
                        ...
                        <div style="display: flex; gap: 20px;">
                            <div class="form-field" style="flex:1;">
                                ...
                                <div class="txt-container glass-effect-border">
                                    <input type="text" class="readonly-box" value="<?php echo $data['dob']; ?>" readonly>
                                </div>
                            </div>
                            <div class="form-field" style="flex:1;">
                                <label>Gender</label>
                                <div class="txt-container glass-effect-border">
                                    <input type="text" class="readonly-box" value="<?php echo $data['gender']; ?>" readonly>
                                </div>
                            </div>
                        </div>
