<!--
    Author: Khoo Lay Bin
    Date: 2026-01-11
    Description: Student Event Details Page
-->
...
<head>
    ...
    $participation_query = "SELECT * FROM event_participants WHERE event_id = $event_id AND user_id = $current_user_id";
    $participation_result = mysqli_query($conn, $participation_query);
    $user_participation = mysqli_fetch_assoc($participation_result);
    ...
    $has_participated = $user_participation !== null;


    if ($has_participated) {
        $participant_status = $user_participation['status'];
    } else {
        $participant_status = null;
    }

    $is_attended = $participant_status === 'attended';
    ...
    <title><?php echo htmlspecialchars($event['title']); ?> - GoGreen@APU</title>
    <meta name="description" content="<?php echo htmlspecialchars($event['short_description']); ?>">
...
<body>
    ...
    <div class="main-content">
        <div class="event-page">
            ...
            <a href="/GoGreen-APU/frontend/student/explore/" class="event-back-btn glass-effect-card">
            ...
            <div class="event-grid">
                ...
                <div class="event-sidebar">
                    ...
                    <a href="/GoGreen-APU/frontend/student/explore/?club=<?php echo $event['club_id']; ?>" class="club-card glass-effect-card">
                        <div class="club-logo">
                    ...
                    <?php if ((!$is_deadline_passed && !$is_event_ended) || $is_attended): ?>
                        <div class="registration-card glass-effect-card">
                            ...
                            <div class="participants-info">
                                <div class="participants-header">
                                    <div class="participants-count">
                                        ...
                                        <?php if ($is_attended): ?>
                                            <span><?php echo $participant_count; ?> Attended</span>
                            ...
                            <div class="deadline-row" <?php if ($is_attended || $is_full) echo 'style="display:none;"'; ?>>
                            ...
                            <?php if ($is_attended): ?>
                                <div class="info-note success">
                                    <img class="icon" src="/GoGreen-APU/assets/icons/clock.badge.checkmark.svg" alt="Attended">
                            ...
                            <?php if (!$has_participated && !$is_attended && !$is_full): ?>
                                <form action="/GoGreen-APU/actions/student/event/register.php" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="event_id" value="<?php echo $event_id; ?>">

                                    <div class="ticket-box">
                                        <label class="ticket-row">
                                            <input type="checkbox" class="ticket-checkbox" name="agreement" required>
                                    ...
                                    <?php if ($is_paid): ?>
                                        <div class="pdf-upload-section">
                                            ...
                                            <label class="pdf-upload-area">
                                                ...
                                                <input type="file" class="pdf-input" name="receipt" accept=".pdf" hidden required>
                                            </label>
                                        </div>
                                    <?php endif; ?>
                            ...
                            <?php elseif ($has_participated && !$is_attended): ?>
                                <form action="/GoGreen-APU/actions/student/event/cancel.php" method="POST" onsubmit="return confirm('Are you sure you want to cancel your registration?');">
                                    <input type="hidden" name="event_id" value="<?php echo $event_id; ?>">
                            ...
                            <div class="info-note" <?php if ($is_attended || $is_full) echo 'style="display:none;"'; ?>>
                    ...
                    <?php elseif ($is_deadline_passed || $is_event_ended): ?>
                        <div class="registration-closed-card glass-effect-card">
                            ...
                            <p class="closed-message">
                                ...
                                <?php else: ?>
                                    The registration deadline for this event has passed. You can no longer register.
                                <?php endif; ?>
                            </p>


                            <a href="/GoGreen-APU/frontend/student/explore/" class="browse-btn">Browse Other Events</a>
                    ...
                    <div class="certificate-card glass-effect-card">
                        ...
                        <div class="certificate-buttons">
                            <?php if (!$is_attended): ?>
                                <a href="/GoGreen-APU/frontend/student/certificate/preview/index.php?id=<?php echo $event_id; ?>" class="action-btn"
                                    <?php if (!$is_approved) {
                            ...
                            <?php if ($is_attended && $has_certificate): ?>
                                <a href="/GoGreen-APU/frontend/student/certificate/index.php?id=<?php echo $event_id; ?>" class="action-btn">
                                    <img class="icon" src="/GoGreen-APU/assets/icons/eye.svg" alt="View">
                            ...
                            <?php if ($is_attended && !$has_certificate): ?>
                                <div class="info-note warning">
                                    ...
                                    <span>Waiting for organizer to generate certificate.</span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="feedback-card glass-effect-card">
                        ...
                        <form action="/GoGreen-APU/actions/student/event/comment.php" method="POST" class="feedback-input-area">
                            <input type="hidden" name="event_id" value="<?php echo $event_id; ?>">


                            <div class="txt-container glass-effect-border">
                                <textarea id="feedback-text" name="comment" placeholder="Share your thoughts about the event..." rows="3" required></textarea>

                                <button type="button" class="clear-btn" data-target="feedback-text">
                            ...
                            <div class="feedback-actions">
                                <button type="submit" class="send-feedback-btn">
                        ...
                        <div class="comments-list">
                            <?php if ($comments_result && mysqli_num_rows($comments_result) > 0): ?>
                                ...
                                <?php endwhile; ?>
                            <?php else: ?>
                                <p style="color: rgba(255,255,255,0.4); text-align: center; font-size: 13px; padding: 20px 0;">
