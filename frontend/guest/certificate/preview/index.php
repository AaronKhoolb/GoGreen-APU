<!-- 
    Author: Khoo Lay Bin
    Date: 2025-11-5
    Description: Guest preview cert page that include student preview certificate layout
-->
...
<head>
    ...
    if ($event_id <= 0) {
        header("Location: /GoGreen-APU/frontend/guest/explore/");
        exit;
    }
...
<body>
    ...
    <div class="main-content">
        <div class="certificate-page">
            <a href="/GoGreen-APU/frontend/guest/explore/event/?id=<?php echo $event_id; ?>" class="cert-back-btn glass-effect-card">
                <img class="icon" src="/GoGreen-APU/assets/icons/chevron.left.svg" alt="Back">
            </a>


            <div class="cert-wrapper">
                <?php include($_SERVER['DOCUMENT_ROOT'] . '/GoGreen-APU/frontend/student/certificate/preview/cert.php'); ?>
            </div>
        </div>
    </div>
