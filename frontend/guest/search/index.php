<!-- 
    Author: Khoo Lay Bin
    Date: 2026-1-5
    Description: This search bar will include into guest desktop nav for event name searching
-->


<form action="/GoGreen-APU/frontend/guest/explore/index.php" method="GET" class="desktop-search-bar">
