...
/**
 * Reset Website Logo
 * Restores the logo to the default from the defaults folder
 */
...
// Copy default logo files back
$files_to_reset = [
    'GoGreen@APU logo.svg',
];
...
if ($success) {
    header("Location: $redirect_url?success=logo_reset");
    exit;
} else {
